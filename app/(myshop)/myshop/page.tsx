...
export default function DashBoard() {
    ...
    const columns:TableColumn<ProductType>[] = [
        ...
        {
            name: 'Image',
            selector: (row):JSX.Element|any => <Image className='w-[80px] h-[70px]' src={row.image} width={500} height={500}  alt={row.name}/>,
        },
            ...
            <Modal show={openModal} onClose={() => setOpenModal(false)}>
                ...
                <Modal.Body>
                    <div className="space-y-6">
                        <Image src={productdetail?.image||placeHolderImage} width={500} height={500} alt={productdetail?.name||"Untitle"} className="w-full h-96 object-fit" />
