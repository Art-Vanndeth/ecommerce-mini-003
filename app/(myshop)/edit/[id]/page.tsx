...
const renderPageNumbers = (data:any) => {
    ...
    >
     ...
     {props.map((image:ImageType,index)=>
                <div key={index} className="flex items-center justify-between gap-4 p-4 bg-gray-50">
                    <Image src={image.image} alt={image.name} className="w-20 h-20 object-cover rounded-lg" onClick={()=>handleSelect(index,props,data1,'selectImage')}/>
  ...
  {selectedPhoto && <Image src={selectedPhoto} alt="" />}
    ...
    >
      ...
      >
       ...
       {icons.map((image:ImageType,index)=>
                    <div key={index} className="flex items-center justify-between gap-4 p-4 bg-gray-50">
                        <Image src={image.image} alt={image.name} className="w-20 h-20 object-cover rounded-lg" onClick={()=>handleSelect(index,props,icons,'data1Icon')}/>
                        <h3 className="text-gray-900">{image.name}</h3>
                    </div>
        ...
        <div className="flex justify-center p-4">
             ...
             {selectedIcon && <Image src={selectedIcon} alt="" />}
