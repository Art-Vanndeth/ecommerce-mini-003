...
import { CardProductType } from "@/lib/definitions";
import {Pagination} from "@nextui-org/react";

export default function CardDetailComponent({id, name, description, price, image, onClick}: CardProductType) {
    ...
    return (
        <div>
            <Card
                isBlurred
                className="border-none bg-background/60 dark:bg-default-100/50 max-w-full mx-4"
                shadow="sm"
            >
                <CardBody>
                        ...
                        <div className="flex flex-col col-span-6">
                            ...
                            <div className="flex justify-between items-start">
                                <div className="flex flex-col gap-0">
                                    ...
                                    <h1 className="text-large font-medium"><span className="text-orange-500">$</span>{price}</h1>
                                    <p className="text-small text-foreground/80 mt-4">{description}</p>
                                </div>
                            </div>
